# ASVC-AUTO-NEG-009 , Automated Service automatically becomes Autonomous Service
...
Forbidden automation implication: An Automated Service must NOT automatically be classified as Autonomous Service. Automation is an execution mechanism, not autonomy.
