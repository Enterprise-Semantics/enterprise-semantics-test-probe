# ASVC-AUTO-NEG-003 , Autonomous Service is-a Autonomous Capability
...
Forbidden type inheritance: Autonomous Service is service-level autonomous realization ; Autonomous Capability is capability-level autonomy. The two are distinct semantic kinds.
