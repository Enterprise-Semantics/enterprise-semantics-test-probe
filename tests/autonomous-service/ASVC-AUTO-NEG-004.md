# ASVC-AUTO-NEG-004 , Autonomous Service is-a Autonomous Operations
...
Forbidden type inheritance: Autonomous Service is the service boundary ; Autonomous Operations is the operations boundary. The two are distinct semantic kinds.
