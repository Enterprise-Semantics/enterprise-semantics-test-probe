# ASVC-AUTO-NEG-010 , A Service containing an Agent automatically becomes Autonomous Service
...
Forbidden Agent implication: A Service containing an Agent must NOT automatically be classified as Autonomous Service; autonomous progression must be material to service realization per ASVC-AUTO-CON-003.
