# ACAP-AUTO-NEG-003 , Autonomous Capability is-a Agent
...
Forbidden type inheritance: Autonomous Capability is the what (enduring ability); Agent is the who (the bearer). They are distinct semantic kinds.
