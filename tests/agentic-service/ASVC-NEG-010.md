# ASVC-NEG-010 ; A Service containing an Agent automatically becomes Agentic Service
...
Forbidden Agent implication: A Service containing an Agent must NOT automatically be classified as Agentic Service; agentic behavior must be material to service realization per ASVC-CON-003.
