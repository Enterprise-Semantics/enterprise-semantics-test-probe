# ASVC-NEG-003 ; Agentic Service is-a Agentic Workflow
...
Forbidden type inheritance: Agentic Service is NOT Agentic Workflow. The workflow is an execution mechanism; the service is the service-level construct.
