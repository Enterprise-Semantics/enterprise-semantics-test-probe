# ASVC-NEG-014 ; Agentic Service implies Autonomous Value Stream
...
Forbidden value-stream implication: Agentic Service does NOT imply Autonomous Value Stream. The two are distinct semantic kinds at different semantic levels.
